...
-- RLS policies
CREATE POLICY "Staff can view workers" ON public.workers FOR SELECT USING (is_staff());
CREATE POLICY "Staff can create workers" ON public.workers FOR INSERT WITH CHECK (is_staff());
CREATE POLICY "Staff can update workers" ON public.workers FOR UPDATE USING (is_staff());
...
CREATE POLICY "Staff can view invoice_orders" ON public.invoice_orders FOR SELECT USING (is_staff());
CREATE POLICY "Staff can create invoice_orders" ON public.invoice_orders FOR INSERT WITH CHECK (is_staff());
CREATE POLICY "Staff can update invoice_orders" ON public.invoice_orders FOR UPDATE USING (is_staff());
